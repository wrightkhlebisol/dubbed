...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2017 at 02:08 AM
...
(19, '2017_05_12_125551_create_users_roles_table', 2),
(15, '2017_05_13_181037_create_countries_table', 1),
(16, '2017_05_13_181157_add_country_id_column_to_users', 1),
(20, '2017_05_13_220119_create_photos_table', 3),
(18, '2017_05_12_125148_create_roles_table', 2),
(24, '2017_05_14_195501_create_videos_table', 4),
(25, '2017_05_14_200133_create_tags_table', 4),
(26, '2017_05_14_200236_create_taggables_table', 4);
...
(1, 'edwin.jpg', 1, 'App\\User', NULL, NULL),
(2, 'laravel.jpg', 1, 'App\\Post', NULL, NULL),
(3, 'php.jpg', 1, 'App\\Post', NULL, NULL),
(4, 'python.jpg', 2, 'App\\Post', NULL, NULL);
...
(1, 'New Eloquent title insert', 'Wow, Eloquent is really cool, look at that', '2017-05-12 09:35:26', '2017-05-12 09:35:26', 0, NULL),
(2, 'Javascript Posts 1', 'Javascript is a very powerful language and it is one of if not the widest used language of all time', '2017-05-11 23:00:00', '2017-05-11 23:00:00', 0, NULL),
(3, 'Pete\'s Post', 'This is peter\'s post and we are getting it from the country name', NULL, NULL, 0, NULL),
(12, 'PHP post from tinker', 'PHP content from tinker', '2017-05-14 20:26:15', '2017-05-14 20:26:15', 0, NULL),
(13, 'guest post', '', '2017-05-14 20:35:09', '2017-05-14 20:35:09', 0, NULL);
...
(1, 'Edwin Diaz', 'edwin@codingfaculty.com', '123', NULL, '2017-05-14 18:58:20', '2017-05-14 18:58:20', 1),
(2, 'Peter', 'peter@codingfaculty.com', '123', NULL, NULL, NULL, 2);
...
(1, 'php_insert_videos.mov', NULL, NULL),
(2, 'javascript_alert_functions.mov', NULL, NULL);
...
-- Database: `modub`
--
CREATE DATABASE IF NOT EXISTS `modub` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `modub`;
...
-- Database: `sampdb`
--
CREATE DATABASE IF NOT EXISTS `sampdb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sampdb`;
...
CREATE TABLE `customer` (
  ...
  `zip` char(10) COLLATE latin1_bin DEFAULT NULL
...
(4, 'John Smith', '123 Main Street', 'Liberty', 'CA', '98765');
...
(3, 2, 'Widget 2000', 1, 1, 'The Widget 2000 is a great product. That\'s all');
...
-- Table structure for table `users`
--
-- in use(#29 - File '.\widget_corp\users.MYD' not found (Errcode: 2 - No such file or directory))
-- Error reading data: (#29 - File '.\widget_corp\users.MYD' not found (Errcode: 2 - No such file or directory))
