			...
			<div class="mainsection-snippet">
				...
				?>
						<div id="right-snippet-content-sales">
							...
							<div class="right-snippet-content-sales-headline">
								...
								<b><a href="index.php">Trending <i class="fa fa-navicon"></i></a></b>
							...
							<div class="right-snippet-content-sales-content">
								<?php 
									...
									$query0 = "SELECT f.topic AS topic, f.upload_date AS uploadDate, f.category AS category, u.name AS name";
									...
									while ($total > 0){
										...
										echo "<h5>$snipTopic</h5>
											<div class=\"horzrule\"></div>
											<p>$snipName</p>
											<br>
											<a href=\"index.php\">$snipCategory</a> |
											<p>$snipUploadDate</p>";
										echo "</div>";
										$total--;
									}
				...
				<div id="right-snippet-content-sales">
					...
					<div class="right-snippet-content-sales-headline">
						...
						<b><a href="#">Trending <i class="fa fa-navicon"></i></a></b>
					</div><!-- End of div.right-snippet-content-sales-headline -->
